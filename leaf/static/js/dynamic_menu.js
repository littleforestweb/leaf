                        ...
                        if (allAccountSettings[f][1] === reference && allAccountSettings[f][2] === spanId) {
                            if (allAccountSettings[f][6] && (allAccountSettings[f][6] === "select" || allAccountSettings[f][6] === "multiselect" || allAccountSettings[f][6] === "multi_checkbox")) {
                                ...
                                if (allAccountSettings[f][6] && allAccountSettings[f][6] === "textarea") {
                                    ...
                                    if (type === 'edit') {
                                        $('#e-' + spanId).addClass(mandatoryClass).val(site_dynamic_menu.replace(/__BACKSLASH__TO_REPLACE_ON_WEB__/g, "\\"));
                                    } else {
            ...
            setTimeout(function () {
                ...
                allColumns.push({
                    ...
                    mData: function (source, type, row) {
                        ...
                        val = val.replace(/__BACKSLASH__TO_REPLACE__/g, "\\").replace(/__BACKSLASH__TO_REPLACE_ON_WEB__/g, "\\");
                        ...
                        if (!shouldSplitArray && typeof val === 'string' && val.length > 150) {
                            ...
                            val = val + "...";
                            fullVal = fullVal.replace(/__BACKSLASH__TO_REPLACE__/g, "\\").replace(/__BACKSLASH__TO_REPLACE_ON_WEB__/g, "\\");
                        }
