...
async function populateEditMenuModal(accountId) {
...
async function updateMenu() {
    ...
    $.ajax({
        ...
        data: {
            ...
            "original_menu_name": h_e_list_name,
            "new_menu_name": e_list_name,
    ...
    $('#table').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                targets: 3,
                render: function (data, type, row) {
                    return '<a class="btn btn-sm" href="/menu/' + data + '">View</a><span class="hidden toEdit">' + data + '</span>';
                },
            }
        ]
    });
